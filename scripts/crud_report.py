...
MODULE_ENDPOINTS: dict[str, list[dict[str, str]]] = {
    ...
    "locations": [
        {"method": "POST", "path": "/api/v1/buildings/", "operation": "create building"},
        {"method": "GET", "path": "/api/v1/buildings/", "operation": "list buildings"},
        {"method": "GET", "path": "/api/v1/buildings/{id}", "operation": "read building"},
        {"method": "PUT", "path": "/api/v1/buildings/{id}", "operation": "update building"},
        {"method": "DELETE", "path": "/api/v1/buildings/{id}", "operation": "delete building"},
        {"method": "POST", "path": "/api/v1/sections/", "operation": "create section"},
        {"method": "GET", "path": "/api/v1/sections/", "operation": "list sections"},
        {"method": "POST", "path": "/api/v1/rooms/", "operation": "create room"},
        {"method": "PUT", "path": "/api/v1/rooms/{id}", "operation": "update room"},
        {"method": "DELETE", "path": "/api/v1/rooms/{id}", "operation": "delete room"},
    ],
    "shifts": [
