...
python3 -m app.model_export_worker \
 --source /workspace/weights/face_recognition/linux_trt10/yolov8n-face_batch8_linux.pt \
 --target /workspace/weights/face_recognition/linux_trt10/yolov8n-face_dynamic_b8_trt107.engine \
 --format engine \
 --imgsz 640 \
 --batch 4 \
 --workspace 4 \
...
python3 -m app.model_export_worker \
 --source /workspace/weights/face_recognition/linux_trt10/yolo26s-pose_batch8_linux.pt \
 --target /workspace/weights/face_recognition/linux_trt10/yolo26s-pose_dynamic_b8_trt107.engine \
 --format engine \
 --imgsz 640 \
 --batch 8 \
 --workspace 4 \
...
python3 scripts/build_all_engines.py `  --batch 8`
--workspace 4 `
--device 0
