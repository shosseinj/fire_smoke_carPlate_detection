...
sections = Table(
    ...
    Column("name", Text, nullable=False), Column("description", Text),
    Column("floor", Text), Column("is_active", Integer, nullable=False, server_default="1"),
    *_audit_columns(), *_user_audit_columns(),
)
...
static_videos = Table(
    ...
    Column("id", Integer, primary_key=True, autoincrement=True),
    Column("source_uri", Text, nullable=False, unique=True),
    Column("name", Text, nullable=False),
    Column("source_type", String(16), nullable=False, server_default="static_video"),
    Column("processing_status", String(16), nullable=False, server_default="uploaded"),
